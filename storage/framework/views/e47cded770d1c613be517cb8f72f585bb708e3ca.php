...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <div class="container">
        ...
        <a href="<?php echo e(route('home')); ?>" class="brand-link">
            <img src="<?php echo e(asset('admin/dist/img/stred.png')); ?>" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
...
<!--=============================================================================================================================================================================================== -->               
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item ml-2">
                                <a href="<?php echo e(route('moleculas.molecula3')); ?>" class="nav-link">
                                    <p>Molecula 3</p>
                                </a>
                            </li>
...
</aside><?php /**PATH C:\Users\garci\Documents\qbsixtrack\resources\views/layouts/left-nav.blade.php ENDPATH**/ ?>