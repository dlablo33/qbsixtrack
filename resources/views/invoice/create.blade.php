        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-info">
                    ...
                    <form class="card-body" style="margin: 10px" action="{{ route('invoice.store2') }}" method="POST">
                        @csrf

                        <div class="form-group row">
    <label for="is_invoice" class="col-sm-3 col-form-label">Factura</label>
    <div class="col-sm-9">
        <input type="checkbox" id="is_invoice_checkbox">
    </div>
</div>

<div id="invoice_number_input" style="display: none;">
    <div class="form-group row">
        <label for="invoice_number" class="col-sm-3 col-form-label">Número de Factura</label>
        <div class="col-sm-3">
...
<div class="form-group row">
    <label for="invoice_number" class="col-sm-3 col-form-label">Invoice</label>
    <div class="col-sm-3">
        <input type="text" class="form-control" id="invoice_number" name="invoice_number">
    </div>
</div>
                        ...
                        <div class="form-group row">
                            <label for="bol" class="col-sm-3 col-form-label">BOL</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="bol" name="bol">
                            </div>
...
document.addEventListener("DOMContentLoaded", function() {
        document.getElementById('is_invoice_checkbox').addEventListener('change', function() {
            var invoiceInput = document.getElementById('invoice_number_input');
            if (this.checked) {
